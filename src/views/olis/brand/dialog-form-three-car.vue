...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions([
        'getOneCarTypeDetail','getTwoCarTypeDetail','getAllBrandList','saveThreeCarTypeDetail'
      ]),
      ...
      save() {
        this.$refs['rowData'].validate((valid) => {
          if (valid) {
            ...
            this.saveThreeCarTypeDetail(this.rowData).then(res => {
              if (res.code == 0) {
