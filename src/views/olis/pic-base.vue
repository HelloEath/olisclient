...
<script>
  ...
  import dialogForm from '../../components/olis/dialog/dialog-form-pic-base'
        ...
        tableData: {
          column: [
            ...
            },
            {
              ...
              label: '类型',
              render: (h, scope) => {
                return <span>{ scope.row.imgMaterial.showMaterialType || '无' }</span>
              }
            },
            {
